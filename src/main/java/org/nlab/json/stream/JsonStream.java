 ...
 */
public class JsonStream implements Stream<StreamContext> {

    private final Stream<StreamContext> delegate;
    private final JsonMatcherStreamReader jsonMatcherStreamReader;

    public JsonStream(Stream<StreamContext> delegate, JsonMatcherStreamReader jsonMatcherStreamReader) {
